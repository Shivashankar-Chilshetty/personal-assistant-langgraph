...
const tools: any[] = [search, createEventTool, getEventTool, updateEventTool, deleteEventTool];
                ...
                messages: [
                    {
                        ...
                        3. Leverage available tools (e.g., create-event, get-events, updateEvent, deleteEvent, search) to handle calendar operations automatically & make google search when required.
